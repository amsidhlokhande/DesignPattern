...
public class StringProcessingWithSynchronizedSingleton {

	private static StringProcessingWithSynchronizedSingleton instance = null;
	...
	private StringProcessingWithSynchronizedSingleton() {

	}

	public static synchronized StringProcessingWithSynchronizedSingleton getInstance() {
		...
		if (instance == null) {
			...
			instance = new StringProcessingWithSynchronizedSingleton();
