...
public class StringProcessingWithSynchronizedBlockSingleton {

	private static StringProcessingWithSynchronizedBlockSingleton instance = null;
	...
	private StringProcessingWithSynchronizedBlockSingleton() {

	}

	public static StringProcessingWithSynchronizedBlockSingleton getInstance() {
		...
		if (instance == null) {
			...
			synchronized (StringProcessingWithSynchronizedBlockSingleton.class) {
				if (instance == null) {
					instance = new StringProcessingWithSynchronizedBlockSingleton();
